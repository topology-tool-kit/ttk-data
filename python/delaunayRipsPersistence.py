...
comet67PChuryumovGerasimenkovtp = XMLPolyDataReader(
    FileName=["67P-Churyumov-Gerasimenko.vtp"]
)
tTKDelaunayRipsPersistenceGenerators1 = TTKDelaunayRipsPersistenceGenerators(
    Input=comet67PChuryumovGerasimenkovtp
)
...
SaveData(
    ...
    OutputPort(tTKDelaunayRipsPersistenceGenerators1, 0),
)
...
tTKDelaunayRipsPersistenceDiagram3 = TTKDelaunayRipsPersistenceDiagram(
    Input=hypersphere5Dcsv
)
tTKDelaunayRipsPersistenceDiagram3.InputColumns = [
    "Field 0",
    "Field 1",
    "Field 2",
    "Field 3",
