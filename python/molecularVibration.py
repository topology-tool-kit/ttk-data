...
contour1 = Contour(Input=tTKTopologicalSimplificationByPersistence1)
contour1.ContourBy = ['POINTS', 'opposite']
contour1.Isosurfaces = [0.9995]
contour1.PointMergeMethod = 'Uniform Binning'

# create a new 'Extract Block'
extractBlock8 = ExtractBlock(Input=contour1)
extractBlock8.Assembly = 'Hierarchy'
extractBlock8.Selectors = ['/Root/Block0']

# create a new 'Extract Block'
extractBlock9 = ExtractBlock(Input=contour1)
extractBlock9.Assembly = 'Hierarchy'
extractBlock9.Selectors = ['/Root/Block1']

# create a new 'Extract Block'
extractBlock10 = ExtractBlock(Input=contour1)
extractBlock10.Assembly = 'Hierarchy'
extractBlock10.Selectors = ['/Root/Block2']
