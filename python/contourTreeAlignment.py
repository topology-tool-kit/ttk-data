...
ttkTopologicalSimplificationByPersistence = TTKTopologicalSimplificationByPersistence(Input=ttkCinemaProductReader)
...
ttkMergeandContourTreeFTM = TTKMergeandContourTreeFTM(Input=ttkTopologicalSimplificationByPersistence)
...
QuerySelect(QueryString='(id == 16)', Source=alignmentEdges, FieldType='POINT', InsideOut=0)
...
passSegmentationIDs = TTKArrayEditor(Target=mergeBlocks,
...
extractMatchedGeometry.ImageExtent = [2147483647, -2147483647, 2147483647, -2147483647, 2147483647, -2147483647]
...
ttkEndFor = TTKEndFor(Data=ttkBlockAggregator,
    For=ttkForEach)
