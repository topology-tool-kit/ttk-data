...
QuerySelect(QueryString='(ttkVertexScalarField == 29019)', FieldType='POINT', InsideOut=0, Source=resampleWithDataset1)
extractSelection1 = ExtractSelection(Input=resampleWithDataset1)
ClearSelection()

# create a new 'Extract Selection', creating its query first and clearing it afterwards
QuerySelect(QueryString='(ttkVertexScalarField == 171102)', FieldType='POINT', InsideOut=0, Source=resampleWithDataset1)
extractSelection2 = ExtractSelection(Input=resampleWithDataset1)
ClearSelection()

# create a new 'Extract Selection', creating its query first and clearing it afterwards
QuerySelect(QueryString='(ttkVertexScalarField == 204530)', FieldType='POINT', InsideOut=0, Source=resampleWithDataset1)
extractSelection3 = ExtractSelection(Input=resampleWithDataset1)
ClearSelection()

# create a new 'Extract Selection', creating its query first and clearing it afterwards
QuerySelect(QueryString='(ttkVertexScalarField == 216852)', FieldType='POINT', InsideOut=0, Source=resampleWithDataset1)
extractSelection4 = ExtractSelection(Input=resampleWithDataset1)
ClearSelection()

# create a new 'Extract Selection', creating its query first and clearing it afterwards
QuerySelect(QueryString='(ttkVertexScalarField == 219572)', FieldType='POINT', InsideOut=0, Source=resampleWithDataset1)
extractSelection5 = ExtractSelection(Input=resampleWithDataset1)
ClearSelection()

# create a new 'Append Datasets'
appendDatasets1 = AppendDatasets(Input=[extractSelection1, extractSelection2, extractSelection3, extractSelection4, extractSelection5])

# create a new 'TTK HarmonicField'
tTKHarmonicField1 = TTKHarmonicField(Domain=resampleWithDataset1,
    Constraints=appendDatasets1)
...
threshold1.ThresholdRange = [0.001, 0.9999999999999999]
