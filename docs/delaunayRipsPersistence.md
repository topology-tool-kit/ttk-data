...
The dataset [hypersphere5.csv](https://github.com/topology-tool-kit/ttk-data/raw/dev/coil20.csv) contains 10,000 points in 5D sampled next to a 4-sphere (some Gaussian noise is applied). This point set features one significant 4-dimensional persistent pair.
