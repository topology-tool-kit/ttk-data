...
# create a new 'Threshold'
threshold5 = Threshold(Input=ttkMeshGraph1)
...
# create a new 'Calculator'
calculator3 = Calculator(Input=threshold5)
calculator3.CoordinateResults = 1
calculator3.Function = 'coords+kHat*Size/100'

# create a new 'Threshold'
threshold4 = Threshold(Input=ttkMeshGraph1)
threshold4.Scalars = ['POINTS', 'LevelIndex']

# create a new 'Threshold'
threshold6 = Threshold(Input=ttkMeshGraph1)
