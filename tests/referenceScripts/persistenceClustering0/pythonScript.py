...
renderView14.CameraPosition = [18.4734669470299, 18.8340328481248, 102.297597669232]
renderView14.CameraFocalPoint = [18.4734669470299, 18.8340328481248, 0.0]
renderView14.CameraParallelScale = 21.8814599545723
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
tube6Display.ScaleTransferFunction.Points = [-2.34916925430298, 0.0, 0.5, 0.0, 0.940834522247314, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
tube6Display.OpacityTransferFunction.Points = [-2.34916925430298, 0.0, 0.5, 0.0, 0.940834522247314, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
tube7Display.ScaleTransferFunction.Points = [-2.34916925430298, 0.0, 0.5, 0.0, 0.776334285736084, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
tube7Display.OpacityTransferFunction.Points = [-2.34916925430298, 0.0, 0.5, 0.0, 0.776334285736084, 1.0, 0.5, 0.0]
