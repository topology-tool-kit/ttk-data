...
renderView10.CameraPosition = [0.220163669161564, -0.0743815121698669, 10.6574753000108]
renderView10.CameraFocalPoint = [0.220163669161564, -0.0743815121698669, 0.0]
...
renderView12.CameraPosition = [0.220163669161564, -0.0743815121698669, 10.6574753000108]
renderView12.CameraFocalPoint = [0.220163669161564, -0.0743815121698669, 0.0]
...
renderView13.CameraPosition = [0.220163669161564, -0.0743815121698669, 10.6574753000108]
renderView13.CameraFocalPoint = [0.220163669161564, -0.0743815121698669, 0.0]
...
renderView14.CameraPosition = [24.7607718765722, 24.4092099782416, 102.297597669232]
renderView14.CameraFocalPoint = [24.7607718765722, 24.4092099782416, 0.0]
renderView14.CameraParallelScale = 31.0869103099745
...
splatterValuesLUT.RGBPoints = [0.0, 0.0, 0.129412, 0.584314, 11.1053056716919, 0.917647, 0.941176, 0.788235, 53.4763167624889, 0.0, 0.431373, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
slice1Display.ScaleTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 53.4763167624889, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
slice1Display.OpacityTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 53.4763167624889, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
tube6Display.ScaleTransferFunction.Points = [-2.33333373069763, 0.0, 0.5, 0.0, 1.26824414730072, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
tube6Display.OpacityTransferFunction.Points = [-2.33333373069763, 0.0, 0.5, 0.0, 1.26824414730072, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
tube7Display.ScaleTransferFunction.Points = [-2.33333373069763, 0.0, 0.5, 0.0, 1.24654793739319, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
tube7Display.OpacityTransferFunction.Points = [-2.33333373069763, 0.0, 0.5, 0.0, 1.24654793739319, 1.0, 0.5, 0.0]
...
splatterValuesPWF.Points = [0.0, 0.0, 0.5, 0.0, 53.4763167624889, 1.0, 0.5, 0.0]
