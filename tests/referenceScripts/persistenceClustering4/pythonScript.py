...
renderView14.CameraPosition = [15.7002776111738, 80.4340514523825, 102.297597669232]
renderView14.CameraFocalPoint = [15.7002776111738, 80.4340514523825, 0.0]
...
tTKSphereFromPoint11.Radius = 5.0
...
splatterValuesLUT.RGBPoints = [0.0, 0.0, 0.129412, 0.584314, 86.8650707905432, 0.917647, 0.941176, 0.788235, 173.730141581087, 0.0, 0.431373, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
slice1Display.ScaleTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 173.730141581087, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
slice1Display.OpacityTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 173.730141581087, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
tube6Display.ScaleTransferFunction.Points = [-2.14865398406982, 0.0, 0.5, 0.0, 0.735938429832458, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
tube6Display.OpacityTransferFunction.Points = [-2.14865398406982, 0.0, 0.5, 0.0, 0.735938429832458, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
tube7Display.ScaleTransferFunction.Points = [-2.14865398406982, 0.0, 0.5, 0.0, 0.735938429832458, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
tube7Display.OpacityTransferFunction.Points = [-2.14865398406982, 0.0, 0.5, 0.0, 0.735938429832458, 1.0, 0.5, 0.0]
...
splatterValuesPWF.Points = [0.0, 0.0, 0.5, 0.0, 173.730141581087, 1.0, 0.5, 0.0]
