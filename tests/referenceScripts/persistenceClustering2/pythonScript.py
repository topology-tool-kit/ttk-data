...
renderView10.CameraPosition = [-0.00532513936137657, 0.212604244132057, 10.6574753000108]
renderView10.CameraFocalPoint = [-0.00532513936137657, 0.212604244132057, 0.0]
renderView10.CameraParallelScale = 3.01847518681845
...
renderView12.CameraPosition = [-0.00532513936137657, 0.212604244132057, 10.6574753000108]
renderView12.CameraFocalPoint = [-0.00532513936137657, 0.212604244132057, 0.0]
renderView12.CameraParallelScale = 3.01847518681845
...
renderView13.CameraPosition = [-0.00532513936137657, 0.212604244132057, 10.6574753000108]
renderView13.CameraFocalPoint = [-0.00532513936137657, 0.212604244132057, 0.0]
renderView13.CameraParallelScale = 3.01847518681845
...
renderView14.CameraPosition = [17.2890300702731, 92.47709881906, 102.297597669232]
renderView14.CameraFocalPoint = [17.2890300702731, 92.47709881906, 0.0]
renderView14.CameraParallelScale = 111.496924427472
...
tTKSphereFromPoint11.Radius = 3.0
...
splatterValuesLUT.RGBPoints = [0.0, 0.0, 0.129412, 0.584314, 21.4928855895996, 0.917647, 0.941176, 0.788235, 64.4786605834961, 0.0156862745098039, 0.43921568627451, 0.0156862745098039, 186.868711140218, 0.0, 0.431373, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
slice1Display.ScaleTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 186.868711140218, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
slice1Display.OpacityTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 186.868711140218, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
tube6Display.ScaleTransferFunction.Points = [-2.51952862739563, 0.0, 0.5, 0.0, 1.22601902484894, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
tube6Display.OpacityTransferFunction.Points = [-2.51952862739563, 0.0, 0.5, 0.0, 1.22601902484894, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
tube7Display.ScaleTransferFunction.Points = [-2.51952862739563, 0.0, 0.5, 0.0, 0.0566773638129234, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
tube7Display.OpacityTransferFunction.Points = [-2.51952862739563, 0.0, 0.5, 0.0, 0.0566773638129234, 1.0, 0.5, 0.0]
...
splatterValuesPWF.Points = [0.0, 0.0, 0.5, 0.0, 186.868711140218, 1.0, 0.5, 0.0]
